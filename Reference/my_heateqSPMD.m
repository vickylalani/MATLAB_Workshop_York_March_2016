function U = my_heateqSPMD(nPoints)
...
%figure
%C = imagesc(U, [10, 80]); % Set temp. scale to be 10C to 80C
%axis square
...
%     % Update the graphics.
%     set(C, 'CData', U)
%     drawnow % Render each update
%     title(['t = ', num2str(iter*dt)])
%     pause(0.05)
end
