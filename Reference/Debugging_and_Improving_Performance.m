...
%
% See the file findBestPredictors_V1.
...
try
    predictorRankings = findBestPredictors_V1(); %#ok<*NASGU>
catch MExc
...
% be useful here.)
%
% See the file findBestPredictors_V2 for a version of the code which
...
try
    predictorRankings = findBestPredictors_V2();
catch MExc
    disp(MExc.identifier)
end
...
which findBestPredictors_V2
which getpairs in findBestPredictors_V2
which getPairs in findBestPredictors_V2
...
%
% See the file findBestPredictors_V3 for reference.

%% Debugging Completion.
% After fixing the dependency problem, we now have a function that works.
predictorRankings = findBestPredictors_V3();
...
%
% See the file findBestPredictors_Final for reference.
%
...
%
% See the file Compact for reference here.
...
% Vectorisation medical data calculation script using CELLFUN and
% STRUCTFUN.
%
% See the file Compact for reference here.
